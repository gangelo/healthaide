...
SimpleForm.setup do |config|
  ...
  # Create a custom wrapper for Tailwind styling.
  config.wrappers :tailwind, tag: "div", class: "mb-4" do |b|
    ...
    # The main input + label
    b.use :label, class: "block text-gray-700 font-bold mb-2"
    ...
    # Error & hint messages
    b.use :error, wrap_with: { tag: :span, class: "text-red-500 text-sm" }
    b.use :hint,  wrap_with: { tag: :p, class: "text-gray-600 text-xs italic" }
  end

  # Make Tailwind wrapper the default
